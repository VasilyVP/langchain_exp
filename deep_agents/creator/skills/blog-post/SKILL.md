...
task(
    subagent_type="researcher",
    description="Research the current state of AI agents in 2026. Save findings to research/ai-agents-2026.md"
)
```
...
Example: A post about "AI Agents in 2026" → `blogs/ai-agents-2026/`
